...
def test_areena_series_titles():
    titles = fetch_title('http://areena.yle.fi/1-3826480')
...
def test_areena_series_urls():
    urls = fetch_stream_url('http://areena.yle.fi/1-3826480')
...
def test_areena_html5_clip_title():
    title = fetch_title('http://areena.yle.fi/1-3523087')
...
def test_areena_html5_clip_stream_url():
    streamurl = fetch_stream_url('http://areena.yle.fi/1-3523087')
